...
public final class ChanceCards {
    ...
    private static ArrayList<ChanceCard> chanceCards = new ArrayList<>(Arrays.asList(
        ...
        new MoveRelativeDistance("You realized its Tuesday today.", "You've got a PD assignment to tonight. Move back 6 spaces.", -6),
        ...
        new MoveToTile("It's that time of year. You desperately need to take a Linkedin picture.", "Move to E7 to take a bridge picture", BoardTiles.getBuildingTileByName("E7")), new GainLoseMoney("You got a refund for your WUSA dental/health plan.", "Collect 100", 100),
